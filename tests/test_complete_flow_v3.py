#!/usr/bin/env python3
"""
Complete flow test V3: Registration + Workspace Creation
Tests both Registration and Workspace Ready emails
Fixed: Click button instead of pressing Enter
"""
import random
import string
import time
...
def test_complete_flow():
    ...
    test_data = {
        ...
        'workspace_name': f'complete_ws_{random_id}'
    }

    print("=" * 80)
    print("🎬 TAM KAYIT AKIŞI TESTİ V3")
    print("=" * 80)
    print()
    print("📋 Test Verileri:")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # Click "Create Workspace" button (don't press Enter)
            page.click('button:has-text("Create Workspace")')
            print("   ✅ Create Workspace butonu tıklandı")
            ...
            screenshot_path = f"/tmp/complete_flow_v3_{random_id}.png"
            ...
            print(f"\n❌ HATA: {str(e)}")
            screenshot_path = f"/tmp/error_v3_{random_id}.png"
